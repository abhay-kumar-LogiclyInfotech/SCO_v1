...
//   String? _uuid;
//   num? _version;
// FaqModel copyWith({  String? dDMStructureKey,
//   String? dDMTemplateKey,
//   String? articleId,
//   String? classNameId,
//   String? classPK,
...
//   String? uuid,
//   num? version,
// }) => FaqModel(  dDMStructureKey: dDMStructureKey ?? _dDMStructureKey,
...
class Data {
  Data({
    ...
    this.uuid,
    this.version,
    this.dDMStructureKey,
    this.dDMTemplateKey,});

  Data.fromJson(dynamic json) {
    articleId = json['articleId'];
    classNameId = json['classNameId'];
    ...
    layoutUuid = json['layoutUuid'];
    modifiedDate = json['modifiedDate'];
    resourcePrimKey = json['resourcePrimKey'];
    reviewDate = json['reviewDate'];
    smallImage = json['smallImage'];
    smallImageId = json['smallImageId'];
    ...
    dDMStructureKey = json['DDMStructureKey'];
    dDMTemplateKey = json['DDMTemplateKey'];
  }
  String? articleId;
  String? classNameId;
  int? classPK;
  ...
  Map<String, dynamic> toJson() {
    ...
    map['classNameId'] = classNameId;
    map['classPK'] = classPK;
    map['companyId'] = companyId;
    map['content'] = content;
    map['createDate'] = createDate;
    map['defaultLanguageId'] = defaultLanguageId;
    ...
    map['layoutUuid'] = layoutUuid;
    map['modifiedDate'] = modifiedDate;
    map['resourcePrimKey'] = resourcePrimKey;
    map['reviewDate'] = reviewDate;
    map['smallImage'] = smallImage;
    map['smallImageId'] = smallImageId;
    map['smallImageURL'] = smallImageURL;
    map['status'] = status;
    map['statusByUserId'] = statusByUserId;
    map['statusByUserName'] = statusByUserName;
    map['statusDate'] = statusDate;
    map['treePath'] = treePath;
    map['urlTitle'] = urlTitle;
    map['userId'] = userId;
    map['userName'] = userName;
    map['uuid'] = uuid;
    map['version'] = version;
    map['DDMStructureKey'] = dDMStructureKey;
    map['DDMTemplateKey'] = dDMTemplateKey;
    return map;
  }
