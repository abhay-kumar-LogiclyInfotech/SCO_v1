...
/// data : {"applicationNumber":null,"applicationData":null,"psApplicartion":null}
/// error : false

UpdatePeopleSoftApplicationModel updatePeopleSoftApplicationModelFromJson(String str) => UpdatePeopleSoftApplicationModel.fromJson(json.decode(str));
String updatePeopleSoftApplicationModelToJson(UpdatePeopleSoftApplicationModel data) => json.encode(data.toJson());
class UpdatePeopleSoftApplicationModel {
  UpdatePeopleSoftApplicationModel({
      String? messageCode, 
      String? message, 
      Data? data, 
      bool? error,}){
  ...
  UpdatePeopleSoftApplicationModel.fromJson(dynamic json) {
  ...
  Data? _data;
  bool? _error;
UpdatePeopleSoftApplicationModel copyWith({  String? messageCode,
  String? message,
  Data? data,
  bool? error,
}) => UpdatePeopleSoftApplicationModel(  messageCode: messageCode ?? _messageCode,
...
Data copyWith({  dynamic applicationNumber,
  dynamic applicationData,
  dynamic psApplicartion,
  ...
  dynamic get applicationNumber => _applicationNumber;
