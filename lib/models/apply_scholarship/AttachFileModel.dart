...
AttachFileModel attachFileModelFromJson(String str) => AttachFileModel.fromJson(json.decode(str));
String attachFileModelToJson(AttachFileModel data) => json.encode(data.toJson());
class AttachFileModel {
  ...
  AttachFileModel.fromJson(dynamic json) {
  ...
  Data? _data;
  bool? _error;
AttachFileModel copyWith({  String? messageCode,
  String? message,
  Data? data,
  bool? error,
}) => AttachFileModel(  messageCode: messageCode ?? _messageCode,
