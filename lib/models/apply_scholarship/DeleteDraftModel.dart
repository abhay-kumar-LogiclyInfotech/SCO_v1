...
/// data : {"applicationNumber":"36775","applicationData":null,"psApplicartion":null}
/// error : true

DeleteDraftModel deleteDraftModelFromJson(String str) => DeleteDraftModel.fromJson(json.decode(str));
String deleteDraftModelToJson(DeleteDraftModel data) => json.encode(data.toJson());
class DeleteDraftModel {
  ...
  DeleteDraftModel.fromJson(dynamic json) {
  ...
  Data? _data;
  bool? _error;
DeleteDraftModel copyWith({  String? messageCode,
  String? message,
  Data? data,
  bool? error,
}) => DeleteDraftModel(  messageCode: messageCode ?? _messageCode,
