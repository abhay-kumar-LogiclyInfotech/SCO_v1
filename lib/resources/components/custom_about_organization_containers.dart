...
class _CustomAboutOrganizationContainersState
    extends State<CustomAboutOrganizationContainers> with MediaQueryMixin<CustomAboutOrganizationContainers>{
  @override
  Widget build(BuildContext context) {
    ...
    double iconSize = orientation == Orientation.portrait ? 25.0 : 100.0;
