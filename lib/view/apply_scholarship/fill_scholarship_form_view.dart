  ...
  void _initializer() {
    WidgetsBinding.instance.addPostFrameCallback((callback) {
      ...
      _caseStudyYearDropdownMenuItems = populateCommonDataDropdown(
          menuItemsList: Constants.lovCodeMap['BATCH#${_selectedScholarship
              ?.acadmicCareer}']!.values!,
          provider: langProvider,
          textColor: AppColors.scoButtonColor);
...
// cgpa
        ...
        CustomTextField(
          ...
          nextFocusNode: graduationInfo.graduationEndDateFocusNode,
        ...
        CustomTextField(
          ...
          nextFocusNode: graduationInfo.sponsorShipFocusNode,
                  ...
                  if (graduationInfo.sponsorShipFocusNode.hasFocus) {
                    setState(() {
                      graduationInfo.sponsorShipError =
                          ErrorText.getEmptyFieldError(
                              name: graduationInfo.sponsorShipController.text,
                              context: context);
                    });
                  }
                }),
        ...
        Column(
          ...
          children: [
                  ...
                  if (graduationInfo.caseStudyTitleFocusNode.hasFocus) {
                    setState(() {
                      graduationInfo.caseStudyTitleError =
                          ErrorText.getNameArabicEnglishValidationError(
                              name: graduationInfo.caseStudyTitleController
                                  .text,
                              context: context);
                    });
                  }
            ...
            _scholarshipFormDropdown(
              ...
              currentFocusNode: graduationInfo.caseStudyStartYearFocusNode,
              ...
              onChanged: (value) {
                ...
                setState(() {
                  ...
                  Utils.requestFocus(
                      focusNode: graduationInfo.caseStudyDescriptionFocusNode,
                      context: context);
                });
              },
            ),
