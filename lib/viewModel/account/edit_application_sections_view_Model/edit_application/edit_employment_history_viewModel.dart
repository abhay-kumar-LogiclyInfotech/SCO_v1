...
class EditEmploymentHistoryViewModel with ChangeNotifier {

  late AuthService _authService;
  late AlertServices _alertServices;

  EditEmploymentHistoryViewModel()
  {
  ...
  editEmploymentHistory({dynamic applicationNumber, dynamic form}) async {
    ...
    if (networkController.isConnected.value) {
      ...
      try {
        ...
        dynamic response = await _myRepo.editEmploymentHistory(userId: _userId ?? '',applicationNumber: applicationNumber,body: body,headers: headers);
